...
public sealed class DestroyButtonNoAdsInputSystem : ICleanupSystem {

    readonly IGroup<InputEntity> _group;
    readonly List<InputEntity> _buffer = new List<InputEntity>();

    public DestroyButtonNoAdsInputSystem(Contexts contexts) {
        _group = contexts.input.GetGroup(InputMatcher.ButtonNoAds);
    }
